---
title: Architecture
description: ASH is split around a small shell and agent kernel.
---
...
The current shell intentionally supports only simple commands and a small builtin set. The parser, AST, expander, and evaluator are separate so POSIX, Bash, and Zsh features can be added without collapsing everything into process spawning code.
